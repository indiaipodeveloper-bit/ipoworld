        ...
        {isLoading ? (
          ...
          <>
            <div
              ...
              } text-white bg-black/70 transition-all duration-300 text-lg lg:text-xl text-center top-1/4 w-1/3 z-50 my-5  fixed font-extrabold gap-x-10 justify-center items-center rounded-lg backdrop-blur-sm p-4`}
            >
              <FaLongArrowAltLeft />
